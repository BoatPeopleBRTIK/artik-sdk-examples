...
struct test_device {
	...
	artik_error(*level_control_get_value)(artik_zigbee_endpoint_handle handle,
										  int *value);
	artik_error(*illum_set_measured_value_range)(artik_zigbee_endpoint_handle handle,
												 int min, int max);
	artik_error(*illum_set_measured_value)(artik_zigbee_endpoint_handle handle,
										   int value);
	artik_error(*illum_get_measured_value)(artik_zigbee_endpoint_handle handle,
										   int *value);
	artik_error(*reset_to_factory_default)(artik_zigbee_endpoint_handle handle,
										   const artik_zigbee_endpoint *endpoint);
